const CACHE_NAME = 'msv-wealthtrack-v202603271721';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202603271721',
    './app.js?v=202603271721',
    './storage.js?v=202603271721',
    './mock_data.js?v=202603271721',
    './nextcloud.js?v=202603271721',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
