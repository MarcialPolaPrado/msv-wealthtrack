const CACHE_NAME = 'msv-wealthtrack-v202603271621';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202603271621',
    './app.js?v=202603271621',
    './storage.js?v=202603271621',
    './mock_data.js?v=202603271621',
    './nextcloud.js?v=202603271621',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
