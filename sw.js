const CACHE_NAME = 'msv-wealthtrack-v202604040728';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202604040728',
    './app.js?v=202604040728',
    './storage.js?v=202604040728',
    './mock_data.js?v=202604040728',
    './nextcloud.js?v=202604040728',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
