const CACHE_NAME = 'msv-wealthtrack-v202604030716';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202604030716',
    './app.js?v=202604030716',
    './storage.js?v=202604030716',
    './mock_data.js?v=202604030716',
    './nextcloud.js?v=202604030716',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
