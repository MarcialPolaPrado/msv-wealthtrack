const CACHE_NAME = 'msv-wealthtrack-v202603221614';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202603221610',
    './app.js?v=202603221614',
    './storage.js?v=202603221610',
    './mock_data.js?v=202603221610',
    './nextcloud.js?v=202603221610',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
