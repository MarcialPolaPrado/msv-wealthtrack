const CACHE_NAME = 'msv-wealthtrack-v202604020933';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202604020933',
    './app.js?v=202604020933',
    './storage.js?v=202604020933',
    './mock_data.js?v=202604020933',
    './nextcloud.js?v=202604020933',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
