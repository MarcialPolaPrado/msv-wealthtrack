const CACHE_NAME = 'msv-wealthtrack-v202604020908';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202604020908',
    './app.js?v=202604020908',
    './storage.js?v=202604020908',
    './mock_data.js?v=202604020908',
    './nextcloud.js?v=202604020908',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
