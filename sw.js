const CACHE_NAME = 'msv-wealthtrack-v202604021407';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202604021407',
    './app.js?v=202604021407',
    './storage.js?v=202604021407',
    './mock_data.js?v=202604021407',
    './nextcloud.js?v=202604021407',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
