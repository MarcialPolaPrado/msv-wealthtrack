const CACHE_NAME = 'msv-wealthtrack-v202604041505';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202604041505',
    './app.js?v=202604041505',
    './storage.js?v=202604041505',
    './mock_data.js?v=202604041505',
    './nextcloud.js?v=202604041505',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
