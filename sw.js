const CACHE_NAME = 'msv-wealthtrack-v202603262202';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202603262202',
    './app.js?v=202603262202',
    './storage.js?v=202603262202',
    './mock_data.js?v=202603262202',
    './nextcloud.js?v=202603262202',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
