const CACHE_NAME = 'msv-wealthtrack-v202603311818';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202603311818',
    './app.js?v=202603311818',
    './storage.js?v=202603311818',
    './mock_data.js?v=202603311818',
    './nextcloud.js?v=202603311818',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
