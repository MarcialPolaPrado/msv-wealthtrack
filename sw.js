const CACHE_NAME = 'msv-wealthtrack-v202603271719';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202603271719',
    './app.js?v=202603271719',
    './storage.js?v=202603271719',
    './mock_data.js?v=202603271719',
    './nextcloud.js?v=202603271719',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
