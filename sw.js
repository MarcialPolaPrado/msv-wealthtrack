const CACHE_NAME = 'msv-wealthtrack-v202603301441';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202603301441',
    './app.js?v=202603301441',
    './storage.js?v=202603301441',
    './mock_data.js?v=202603301441',
    './nextcloud.js?v=202603301441',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
