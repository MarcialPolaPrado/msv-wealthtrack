const CACHE_NAME = 'msv-wealthtrack-v202604011515';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202604011515',
    './app.js?v=202604011515',
    './storage.js?v=202604011515',
    './mock_data.js?v=202604011515',
    './nextcloud.js?v=202604011515',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
