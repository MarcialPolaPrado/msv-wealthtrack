const CACHE_NAME = 'msv-wealthtrack-v202604020928';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202604020928',
    './app.js?v=202604020928',
    './storage.js?v=202604020928',
    './mock_data.js?v=202604020928',
    './nextcloud.js?v=202604020928',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
