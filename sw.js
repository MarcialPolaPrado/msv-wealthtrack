const CACHE_NAME = 'msv-wealthtrack-v202604021553';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202604021553',
    './app.js?v=202604021553',
    './storage.js?v=202604021553',
    './mock_data.js?v=202604021553',
    './nextcloud.js?v=202604021553',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
