const CACHE_NAME = 'msv-wealthtrack-v202603241318';
const ASSETS = [
    './',
    './index.html',
    './styles.css?v=202603231407',
    './app.js?v=202603241318',
    './storage.js?v=202603221625',
    './mock_data.js?v=202603221625',
    './nextcloud.js?v=202603221625',
    './manifest.json',
    './icon-192.png',
    './icon-512.png',
